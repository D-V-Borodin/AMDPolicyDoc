...
2)	Make data processing as automatic as possible and make the routines available (API approach is a good pratice) as open source software with necessary documentation.
...
8) The proposed initiative will require focused attention and effort to be realised. Thus, it would necessary for the stakeholders to provide resources and, equally important, appoint liason officers to coordinate actions and maintain this activity in the long run.
